...
) ENGINE=InnoDB AUTO_INCREMENT=10003 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;

-- ----------------------------
-- Records of yoshop_category
-- ----------------------------
BEGIN;
INSERT INTO `yoshop_category` VALUES (10001, 10001, '衣服', 0, 10001, 100, 1566816477, 1566816597);
INSERT INTO `yoshop_category` VALUES (10002, 10001, '男装', 10001, 0, 100, 1566910584, 1566910584);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `yoshop_goods` VALUES (1, 10001, '单规格--卡通男装', 10001, 10, 10, '&lt;p&gt;&lt;img src=&quot;http://devyh.com/uploads/20190901174952a62dd1782.png&quot; _src=&quot;http://devyh.com/uploads/20190901174952a62dd1782.png&quot;/&gt;&lt;/p&gt;', 23, 0, 100, 1, 10, 0, 1567331401, 1567331401);
INSERT INTO `yoshop_goods` VALUES (2, 10001, '多规格--卡通男装', 10002, 20, 20, '&lt;p&gt;&lt;img src=&quot;http://devyh.com/uploads/2019090117525269a036642.png&quot; _src=&quot;http://devyh.com/uploads/2019090117525269a036642.png&quot;/&gt;&lt;/p&gt;', 0, 0, 100, 1, 10, 0, 1567331574, 1567331574);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `yoshop_goods_image` VALUES (1, 1, 2, 1567331401);
INSERT INTO `yoshop_goods_image` VALUES (2, 1, 1, 1567331401);
INSERT INTO `yoshop_goods_image` VALUES (3, 2, 3, 1567331574);
INSERT INTO `yoshop_goods_image` VALUES (4, 2, 2, 1567331574);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `yoshop_goods_spec` VALUES (1, 1, 'asd1', 100.00, 120.00, 999, 0, 10, '', 1567331401, 1567331401);
INSERT INTO `yoshop_goods_spec` VALUES (2, 2, 'asd2', 110.00, 150.00, 999, 0, 11, '1_3', 1567331574, 1567331574);
INSERT INTO `yoshop_goods_spec` VALUES (3, 2, 'asd3', 120.00, 160.00, 888, 0, 12, '1_4', 1567331574, 1567331574);
INSERT INTO `yoshop_goods_spec` VALUES (4, 2, 'asd4', 130.00, 170.00, 777, 0, 13, '2_3', 1567331574, 1567331574);
INSERT INTO `yoshop_goods_spec` VALUES (5, 2, 'asd5', 140.00, 180.00, 666, 0, 14, '2_4', 1567331574, 1567331574);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `yoshop_goods_spec_rel` VALUES (1, 2, 1, 1, 1567331574);
INSERT INTO `yoshop_goods_spec_rel` VALUES (2, 2, 1, 2, 1567331574);
INSERT INTO `yoshop_goods_spec_rel` VALUES (3, 2, 2, 3, 1567331574);
INSERT INTO `yoshop_goods_spec_rel` VALUES (4, 2, 2, 4, 1567331574);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=3749 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `yoshop_setting` (
  ...
  `wxapp_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '小程序id',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间',
  UNIQUE KEY `unique_key` (`key`,`wxapp_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
-- ----------------------------
BEGIN;
INSERT INTO `yoshop_spec` VALUES (1, '颜色', 1567331497);
INSERT INTO `yoshop_spec` VALUES (2, '尺寸', 1567331507);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `yoshop_spec_value` VALUES (1, '黄', 1, 1567331497);
INSERT INTO `yoshop_spec_value` VALUES (2, '白', 1, 1567331500);
INSERT INTO `yoshop_spec_value` VALUES (3, '大', 2, 1567331507);
INSERT INTO `yoshop_spec_value` VALUES (4, '中', 2, 1567331510);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=10002 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='商城表';
...
-- ----------------------------
BEGIN;
INSERT INTO `yoshop_store_user` VALUES (10001, 10001, 'admin1', '9c4cb25665cf08667c815420ab383cb5', 1567162122, 1567243800);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `yoshop_upload_file` VALUES (1, 'local', 0, 10001, '', '201909011747311e37a5372.png', 1136, 'image', 'png', 1, 1567331251);
INSERT INTO `yoshop_upload_file` VALUES (2, 'local', 10001, 10001, '', '20190901174814713379916.jpeg', 16890, 'image', 'jpeg', 0, 1567331294);
INSERT INTO `yoshop_upload_file` VALUES (3, 'local', 10001, 10001, '', '2019090117484813fbc6719.png', 44226, 'image', 'png', 0, 1567331328);
INSERT INTO `yoshop_upload_file` VALUES (4, 'local', 10006, 10001, '', '20190901174952a62dd1782.png', 44226, 'image', 'png', 1, 1567331392);
INSERT INTO `yoshop_upload_file` VALUES (5, 'local', 10006, 10001, '', '2019090117525269a036642.png', 1136, 'image', 'png', 1, 1567331572);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=10008 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;

-- ----------------------------
-- Records of yoshop_upload_group
-- ----------------------------
BEGIN;
INSERT INTO `yoshop_upload_group` VALUES (10001, 10001, 'image', '衣服1', 100, 1566816922, 1566816922);
INSERT INTO `yoshop_upload_group` VALUES (10005, 10001, 'image', 'ccc', 100, 1567604668, 0);
INSERT INTO `yoshop_upload_group` VALUES (10006, 10001, 'image', 'ddd', 100, 1567604704, 0);
INSERT INTO `yoshop_upload_group` VALUES (10007, 10001, 'image', 'eee', 100, 1567604780, 0);
COMMIT;
...
CREATE TABLE `yoshop_wxapp_page` (
  ...
  KEY `wxapp_id` (`wxapp_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=10002 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
